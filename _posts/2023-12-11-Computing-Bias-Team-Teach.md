...
D. "favors candidates" "exlusion of qualified applicants from diverse backgrounds"
...
This is racial bias. This occured because people in the lab that were testing the computer's recognition system probably had lighter skin, leading to the computer only being trained to recognized lighter skinned people. This could have occured because there wasn't enough testing done, or there was not enough dark-skinned people at the facility that were hired to develop and test the program correctly. It was most likely unintentional, but could have been intentional if the company was racist and didn't hire dark-skinned people.  
...
This could be something like filling in a form at the doctor's office.
...
The strategy of classifier correction could be used. By focusing on fixing the algorithm, the root cause can be fixed, and band-aid solutions would not have to be used. Once the algorithm was made fair and non-biased through retraining and recoding, it could be used without discrimination, and wouldn't target certain places more than others. Computing bias could be eliminated through retraining and redeveloping the algorithm.
